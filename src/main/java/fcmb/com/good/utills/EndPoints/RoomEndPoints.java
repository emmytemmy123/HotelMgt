...
public class RoomEndPoints {
    ...
    public static final String ROOM_FACILITY="/roomFacility";
    ...
    public static final String SEARCH_ROOM_FACILITY_BY_ROOM_NUMBER_AND_CUSTOMER = ROOM_FACILITY+"/searchRoomFacilityListByRoomNumber";
