...
public class ServiceEndPoints {
    ...
    public static final String FIND_SUB_SERVICE_REQUEST=SERVICE_REQUEST+"/list";
    public static final String ADD_SUB_SERVICE_REQUEST= SERVICE_REQUEST+"/add";
    public static final String FIND_SUB_SERVICE_REQUEST_BY_ID= SERVICE_REQUEST+"/{id}";
    public static final String UPDATE_SUB_SERVICE_REQUEST= SERVICE_REQUEST+"/update/{id}";
    public static final String DELETE_SUB_SERVICE_REQUEST= SERVICE_REQUEST+"/delete/{id}";
