...
//        verify(userService, times(1)).getListOfUsers(1, 10);
    ...
    public void testGetUsersById() {
        ...
        mockUser.setAddress("N0 3 park lane ");
        mockUser.setCountry("Nigeria");
        mockUser.setCity("lagos");
        mockUser.setGender("male");
        mockUser.setPassword("adezy");
        mockUser.setPhone("09056742366");
        mockUser.setUsername("adezy");
        mockUser.setDesignation("admin");
